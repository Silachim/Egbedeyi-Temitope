...
function InlineMarkdown({ text }) {
  return tokenizeInlineMarkdown(text).map(
    (token, index) => {
    ...
    <article className="blog-post-page">
      {draftPreviewAllowed &&
        rawPost.status ===
          'draft' && (
          <div
            className="blog-draft-preview-banner"
            role="status"
          >
            Local draft preview · This
            article will not appear in
            production while its status is
            draft.
          </div>
        )}
      ...
      <header className="blog-post-hero">
        <div className="blog-post-shell">
          ...
          {post.authorshipNote && (
            <p className="blog-post-authorship-note">
              {post.authorshipNote}
            </p>
          )}
        </div>
      ...
      {(newer || older) &&
        rawPost.status ===
          'published' && (
          <nav
            className="blog-post-pagination"
